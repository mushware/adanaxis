...
#define yyparse MushcoreBison_parse
#define yylex MushcoreBison_lex
#define yyerror MushcoreBison_error
#define yylval MushcoreBison_lval
#define yychar MushcoreBison_char
#define yydebug MushcoreBison_debug
#define yynerrs MushcoreBison_nerrs
#define	NUMBER	257
#define	VARIABLE	258
