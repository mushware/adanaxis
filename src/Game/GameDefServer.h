...
//%includeGuardStart } WjgeoDQh+OfvmrDyRAEgiw
//%Header {
/*****************************************************************************
 *
 * File: src/Game/GameDefServer.h
 *
...
/*
 * $Id: GameDefServer.h,v 1.14 2003/08/21 23:08:43 southa Exp $
...
private:
    ...
    typedef std::map<std::string, void (GameDefServer::*)(MushcoreXML& inXML)> ElementFunctionMap;
