//%includeGuardStart {
#ifndef MUSHSKINNOISE_H
#define MUSHSKINNOISE_H
//%includeGuardStart } CG+2olrqp4+Fa/op5nI0Uw
//%Header {
/*****************************************************************************
 *
...
class MushSkinNoise : public MushcoreVirtualObject
{
public:
    MushSkinNoise();
...
//%inlineHeader {
inline std::ostream&
operator<<(std::ostream& ioOut, const MushSkinNoise& inObj)
{
    inObj.AutoPrint(ioOut);
    return ioOut;
}
//%inlineHeader } Dr2uv4fzFSH+ISr9m40c4Q
//%includeGuardEnd {
#endif
