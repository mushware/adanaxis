...
#define yyparse CoreBison_parse
#define yylex CoreBison_lex
#define yyerror CoreBison_error
#define yylval CoreBison_lval
#define yychar CoreBison_char
#define yydebug CoreBison_debug
#define yynerrs CoreBison_nerrs
#define	NUMBER	257
#define	VARIABLE	258
...
/*
 * $Id: CoreBison.cpp,v 1.10 2002/06/27 12:36:02 southa Exp $
 * $Log: CoreBison.cpp,v $
...
"VARIABLE","IDENTIFIER","STRING","EOS","END_OF_FILE","'+'","','","'('","')'",
"input","end","command","scalar","parameter","parameter_list","command_tail",
"statement", NULL
};
#endif
