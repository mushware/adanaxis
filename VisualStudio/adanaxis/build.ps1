...
$build_process = Start-Process -NoNewWindow -PassThru -Wait -FilePath "MSBuild.exe" -ArgumentList "adanaxis.sln", "/nodeReuse:false", "/t:adanaxis",  "/p:Configuration=`"$Configuration`"", "/p:Version=`"$Version`""
